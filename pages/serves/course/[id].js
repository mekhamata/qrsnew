...
const LeftSide = () =>{
  ...
  return(
    <div className={styles.realLeftSide}>
      <div className={styles.realLeftSide_greyTitle} style={{borderRadius:'20px 20px 0 0'}}>{t('course:coursedetails')}</div>
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('common:category')}:</div>
      ...
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('course:courselength')}:</div>
        <div className={styles.realLeftSide_lines_b}>
          8 שעות
        </div>
      </div>
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('course:startdate')}:</div>
        <div className={styles.realLeftSide_lines_b}>
          10-11-2020
        </div>
      </div>
      <div className={styles.realLeftSide_greyTitle}>{t('course:coursecoo')}</div>
      <div className={styles.realLeftSide_lines}>
      ...
      <div className={styles.realLeftSide_greyTitle}>{t('course:interested')}</div>
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('course:sendtofriend')}</div>
        <div className={styles.realLeftSide_lines_b}>
          <NavLink
              href='/'
              className={styles.navlink__active}
      ...
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('course:downloadregisterdoc')}</div>
        <div className={styles.realLeftSide_lines_b}>
          <NavLink
              href='/'
              className={styles.navlink__active}
      ...
      <div className={styles.realLeftSide_lines}>
        <div className={styles.realLeftSide_lines_a}>{t('course:onlineregister')}</div>
        <div className={styles.realLeftSide_lines_b}>
          <NavLink
              href='/'
              className={styles.navlink__active}
      ...
      {t('course:moreinfo')}<br/>
      {t('course:filldetails')}
      </div>
      <form>
        <div className={styles.realLeftSide_form_input}><input type='text' name='' placeholder={t('common:fullname')} /></div>
        <div className={styles.realLeftSide_form_input}><input type='text' name='' placeholder={t('common:phone')} /></div>
        <div className={styles.realLeftSide_form_input}><input type='text' name='' placeholder={t('common:email')} /></div>
        <input type='hidden' name='courseData' />
        <div className={styles.realLeftSide_form_button}><button>{t('common:send')}</button></div>
      </form>
    </div>
  )
}
      ...
      <div id='pageData' className={styles.pageData}>
        <div id='pageDataIn' className={styles.pageDataInContainer}>
          <div className={styles.courseInfoContainer}>
            <div className={`${styles.courseInfoTitle} ${styles.courseInfoTitle1}`}>
            ...
            <div className={`${styles.courseInfoTitle} ${styles.courseInfoTitle2}`}>
            <div className={styles.contentMainTitle_copy}>
                <h1>דרישות לרישום מכשור רפואי למתחילים ב ZOOM</h1>
              </div>
            </div>
